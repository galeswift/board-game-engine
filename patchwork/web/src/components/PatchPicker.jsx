...
// covers "not your turn" / game not in-progress. `patches` comes from
// the server (App.jsx's loadPatches()) rather than a static import, so
// it starts empty until that fetch resolves - renders no tiles yet
// rather than erroring.
export default function PatchPicker({ patches, availablePatches, playerMoney, selectedPatchId, onSelect, disabled }) {
