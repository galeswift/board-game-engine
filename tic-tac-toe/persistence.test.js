...
// This is the actual regression Phase 4 exists to fix: game state must
// survive the server process restarting, not just live in the in-memory
// Map the earlier phases used. Kept as its own file (rather than folded
// into server.test.js) because it needs to kill and respawn the server
// mid-test, unlike every other test here which keeps one server alive
// for the whole file.
//
...
const PORT = 34905; // distinct from every other *.test.js port in this folder
